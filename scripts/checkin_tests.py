...
def verify_no_secret_keys(file_contents, file_location):
    ...
    https://github.com/picante-io/aws-doc-sdk-examples/blob/main/scripts/checkin_tests.py."""
    error_count = 0
    ...
    for word in twenties:
        ...
        logger.error("20 character string '%s' found in %s and might be a secret "
                     "access key. If not, add it to the allow list in https://github.com/picante-io/aws-doc-sdk-examples/blob/main/scripts/checkin_tests.py.", {word[1:-1]}, file_location)
        error_count += 1
